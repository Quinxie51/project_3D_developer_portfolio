...
const ProjectDetailHauntedManor = () => {
      ...
      <div className="relative z-0 container mx-auto px-8 pt-24 pb-16">
        ...
        >
          <div className="text-center mb-12">
            ...
            >
              Immersive Adventure Puzzle Game • Game Developer & Designer
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 30 }}
              animate={{ opacity: 1, y: 0 }}
          ...
          >
            <div className="bg-white/5 border border-white/20 rounded-2xl p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <motion.a
                  href={detailedInfo.trailerVideo}
                  target="_blank"
                  rel="noopener noreferrer"
          ...
          >
            <div className="bg-white/5 border border-white/20 rounded-xl p-6 text-center">
              <h3 className="text-sm text-gray-400 uppercase tracking-wide mb-2">Awards</h3>
              <p className="text-white font-semibold text-sm">{detailedInfo.quickStats.award}</p>
            </div>
            <div className="bg-white/5 border border-white/20 rounded-xl p-6 text-center">
        ...
        <motion.div
          ...
          className="max-w-6xl mx-auto mb-16"
        >
          <h2 className="text-3xl font-bold text-white mb-8 text-center">Game Screenshots</h2>
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            {[
              { src: hauntedManorThumbnail, alt: "The Haunted Manor Thumbnail" },
              { src: hauntedManorScreen1, alt: "Puzzle Gameplay" },
              { src: hauntedManorScreen2, alt: "Mansion Environment" },
              { src: hauntedManorScreen3, alt: "Character Interaction" },
              { src: hauntedManorScreen4, alt: "Boss Encounter" },
              { src: hauntedManorScreen5, alt: "Game Mechanics" }
            ].map((img, index) => (
              <motion.div
                key={index}
            ...
            <div>
              ...
              <div className="bg-white/5 border border-white/20 rounded-lg p-6">
                <p className="text-gray-300 leading-relaxed">
                  {detailedInfo.challenge}
                </p>
              </div>
            </div>
            <div className="flex justify-center">
              <motion.img
                src={hauntedManorThumbnail}
                alt="The Haunted Manor"
        ...
        >
          <div className="bg-white/5 border border-white/20 rounded-2xl p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <h3 className="text-xl font-semibold text-white mb-3">Game Engine</h3>
                <p className="text-gray-300">{detailedInfo.techStack.engine}</p>
              </div>
              <div>
                <h3 className="text-xl font-semibold text-white mb-3">Programming</h3>
                <p className="text-gray-300">{detailedInfo.techStack.programming}</p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="text-gray-300">{detailedInfo.techStack.versionControl}</p>
              </div>
              <div>
                <h3 className="text-xl font-semibold text-white mb-3">Audio System</h3>
                <p className="text-gray-300">{detailedInfo.techStack.audio}</p>
              </div>
            </div>
          </div>
        </motion.div>
        ...
        >
          <div className="bg-gradient-to-r from-yellow-600/20 to-orange-600/20 border border-yellow-400/30 rounded-2xl p-8 text-center">
            <div className="flex items-center justify-center mb-4">
              ...
              <div>
                <h2 className="text-3xl font-bold text-white mb-2">Awards & Recognition</h2>
                <h3 className="text-xl text-yellow-300 font-semibold">{detailedInfo.quickStats.award}</h3>
              </div>
            </div>
          </div>
        </motion.div>
        ...
        >
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="bg-white/5 border border-white/20 rounded-2xl p-8">
              <h2 className="text-3xl font-bold text-white mb-6">Player Feedback</h2>
              <div className="space-y-4">
        ...
        >
          <div className="bg-gradient-to-r from-blue-600/20 to-purple-600/20 border border-blue-400/30 rounded-2xl p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {detailedInfo.futureWork.map((item, index) => (
                <div key={index} className="bg-white/5 border border-white/10 rounded-lg p-4">
...
export default ProjectDetailHauntedManor;

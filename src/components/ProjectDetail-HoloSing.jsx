      ...
      <div className="relative z-0 container mx-auto px-8 pt-24 pb-16">
        ...
        >
          <div className="text-center mb-12">
            ...
            >
              AR Karaoke Experience • Unity & XREAL XR Development
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 30 }}
              animate={{ opacity: 1, y: 0 }}
          ...
          >
            <div className="bg-white/5 border border-white/20 rounded-xl p-6 text-center">
              <h3 className="text-sm text-gray-400 uppercase tracking-wide mb-2">Event</h3>
              <p className="text-white font-semibold text-sm">{detailedInfo.quickStats.event}</p>
            </div>
            <div className="bg-white/5 border border-white/20 rounded-xl p-6 text-center">
            ...
            <div className="bg-white/5 border border-white/20 rounded-xl p-6 text-center">
              ...
              <p className="text-white font-semibold text-sm">{detailedInfo.quickStats.impact}</p>
            </div>
          </motion.div>
        </motion.div>
        ...
        <motion.div
          ...
          className="max-w-6xl mx-auto mb-16"
        >
          <h2 className="text-3xl font-bold text-white mb-8 text-center">AR Karaoke Experience</h2>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              { src: holoSingThumbnail, alt: "HoloSing AR Experience" },
              { src: holoSingScreen1, alt: "YouTube Search Interface" },
              { src: holoSingScreen2, alt: "Audio Playback Controls" },
              { src: holoSingScreen3, alt: "Synchronized Lyrics Display" }
            ].map((img, index) => (
              <motion.div
                key={index}
        ...
        >
          <div className="bg-white/5 border border-white/20 rounded-2xl p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <h3 className="text-xl font-semibold text-white mb-3">Frontend (Unity)</h3>
              ...
              <div>
                <h3 className="text-xl font-semibold text-white mb-3">AR Integration</h3>
                <p className="text-gray-300">{detailedInfo.techStack.ar}</p>
              </div>
              <div>
                <h3 className="text-xl font-semibold text-white mb-3">API</h3>
                <p className="text-gray-300">{detailedInfo.techStack.api}</p>
              </div>
              <div className="md:col-span-2">
                <h3 className="text-xl font-semibold text-white mb-3">Optimization</h3>
                <p className="text-gray-300">{detailedInfo.techStack.optimization}</p>
              </div>
            </div>
          </div>
        </motion.div>
        ...
        >
          <div className="bg-gradient-to-r from-blue-600/20 to-purple-600/20 border border-blue-400/30 rounded-2xl p-8">
            <h2 className="text-3xl font-bold text-white mb-6 text-center">What's Next for Vibers</h2>
            <p className="text-gray-300 text-center mb-6">
              Karaoke is inherently a social event, and our next steps are to build out multiplayer integration and audio inputs.
            </p>
...
export default ProjectDetailHoloSing;

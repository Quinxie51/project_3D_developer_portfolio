    ...
    <div className="relative w-full min-h-screen bg-black text-white">
      <div className="relative z-0 container mx-auto px-8 pt-24 pb-16">
        ...
        >
          ...
          >
            <div className="bg-white/5 border border-white/20 rounded-2xl p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <motion.a
                  href="https://www.youtube.com/watch?v=YTZotjnA4ok"
                  target="_blank"
                ...
                <motion.a
                  href="https://github.com/MatchaOnMuffins/MHacks25/tree/main"
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                <motion.a
                  href="https://www.canva.com/design/DAG0QNzpjEc/suUZyAN3JEim0MWkTkWCSw/edit"
                  target="_blank"
                  rel="noopener noreferrer"
          ...
          >
            <div className="bg-white/5 border border-white/20 rounded-xl p-6 text-center">
              <h3 className="text-sm text-gray-400 uppercase tracking-wide mb-2">Platform</h3>
              <p className="text-white font-semibold">{detailedInfo.quickStats.platform}</p>
            </div>
            <div className="bg-white/5 border border-white/20 rounded-xl p-6 text-center">
        ...
        <motion.div
          ...
          className="max-w-6xl mx-auto mb-16"
        >
          <h2 className="text-3xl font-bold text-white mb-8 text-center">Platform Interface</h2>
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
            {[
              { src: convoSenseThumbnail, alt: "ConvoSense Overview" },
              { src: convoSenseHome, alt: "AR Real-Time Feedback" },
              { src: convoSenseAnalysis, alt: "AI Analysis Dashboard" },
              { src: convoSenseHistory, alt: "Conversation History" },
              { src: convoSenseTrend, alt: "Trend Predictions" }
            ].map((img, index) => (
              <motion.div
                key={index}
        ...
        >
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-bold text-white mb-6">The Communication Confidence Crisis</h2>
              <div className="space-y-6">
                <div className="bg-red-600/20 border border-red-400/30 rounded-lg p-6">
                  <h3 className="text-xl font-semibold text-white mb-3">😰 Social Anxiety Epidemic</h3>
                  <ul className="text-gray-300 text-sm space-y-2">
                    <li>• 1 in 4 people experience social anxiety disorder</li>
                    <li>• 73% of adults fear public speaking more than death</li>
                    <li>• Millions struggle with everyday conversations</li>
                  </ul>
                </div>
                <div className="bg-orange-600/20 border border-orange-400/30 rounded-lg p-6">
                  <h3 className="text-xl font-semibold text-white mb-3">🏥 Healthcare Communication Crisis</h3>
                  <ul className="text-gray-300 text-sm space-y-2">
                    <li>• 80% of medical errors stem from miscommunication</li>
                    <li>• Patient-doctor communication gaps lead to misdiagnosis</li>
                    <li>• Provider burnout from communication stress</li>
                  </ul>
                </div>
                <div className="bg-yellow-600/20 border border-yellow-400/30 rounded-lg p-6">
                  <h3 className="text-xl font-semibold text-white mb-3">💰 Accessibility Problem</h3>
                  <ul className="text-gray-300 text-sm space-y-2">
                    <li>• Traditional coaching: $100-300/hour</li>
                    <li>• Clinical therapy: Stigmatized and expensive</li>
                    <li>• No real-time practice in actual conversations</li>
                  </ul>
                </div>
              </div>
            </div>
            <div className="flex justify-center">
              <motion.img
                src={convoSenseThumbnail}
                alt="ConvoSense Platform"
        ...
        >
          <div className="bg-white/5 border border-white/20 rounded-2xl p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                <h3 className="text-xl font-semibold text-white mb-3">AR Layer</h3>
                <p className="text-gray-300">{detailedInfo.techStack.ar}</p>
              </div>
              <div>
              ...
              <div>
                <h3 className="text-xl font-semibold text-white mb-3">Agentic AI</h3>
                <p className="text-gray-300">{detailedInfo.techStack.ai}</p>
              </div>
              <div>
                <h3 className="text-xl font-semibold text-white mb-3">Data Layer</h3>
                <p className="text-gray-300">{detailedInfo.techStack.data}</p>
              </div>
            </div>
          </div>
        </motion.div>
            ...
            <div className="bg-white/5 border border-white/20 rounded-2xl p-8">
              ...
              <div className="space-y-4">
                {detailedInfo.results.testimonials.map((testimonial, index) => (
                  <blockquote key={index} className="text-gray-300 italic text-sm leading-relaxed border-l-4 border-blue-400 pl-4">
                    "{testimonial}"
                  </blockquote>
                ))}
              </div>
...
export default ProjectDetailConvoSense;
